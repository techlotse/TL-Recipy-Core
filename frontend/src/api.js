...
export const api = {
  ...
  async enableRecipeShare(id, body = {}) {
    return request(`/api/recipes/${id}/share`, { method: 'POST', body, requiresAuth: true });
  },
  ...
  async calculateNutrition(id) {
    return request(`/api/recipes/${id}/nutrition`, { method: 'POST', requiresAuth: true });
  },
  async listTags() {
